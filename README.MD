...
Success! The device at `0x68` is our DS3231. The other addresses (`0x57` and `0x5F`) are other I2C devices on the same bus (in this case, temperature/humidity sensors - TMP117 and SHTC3).
...
- Less accurate timekeeping (genuine modules are ±2ppm or ~1 minute/year)
...
4. Check if your module needs pull-up resistors (most have them built-in)

### Time Resets After Power Cycle

This is normal without a battery! Either:
- Install a CR2032 battery
- Set the time programmatically on each boot
- Store the last known time and restore it on startup
...
- ✅ Clone modules work great once configured properly

Happy making! 🕐

## License

This guide is released under MIT License - feel free to use and modify for your projects!
